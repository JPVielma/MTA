...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Comunidades'), ['controller' => 'Comunidad', 'action' => 'index']) ?></li>
...
<div class="comunidad index large-9 medium-8 columns content">
    <h3><?= __('Comunidad') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $comunidad->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $comunidad->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $comunidad->id], ['confirm' => __('Are you sure you want to delete # {0}?', $comunidad->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
